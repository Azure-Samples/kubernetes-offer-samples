...
| unsupportedVersions  | A list of versions for the specified kubernetes distribution(s) which are unsupported. Supported operators are described below:: |
...
#### To obtain the distribution for a cluster:
  ...
  Examples of distributions include: generic, aks, eks, gke, k3s, openshift, canonical, rancher_rke, aks_edge_k8s, kind, minikube
